...
-- ============================================================
-- AÑADIDO: escala de tallas corregida a 5 niveles
-- XS/S/M/L/XL según clasificación veterinaria oficial.
-- La columna dog_size ya existe — este bloque solo documenta
-- los valores válidos. No hace falta ejecutar nada más en SQL.
-- Valores aceptados: 'xs' | 's' | 'm' | 'l' | 'xl'
-- XS = hasta 5kg, S = 5-10kg, M = 10-25kg, L = 25-45kg, XL = +45kg
-- ============================================================

-- Consulta para ver distribución de tallas cuando tengas datos:
-- select dog_size, count(*) from waitlist where dog_size is not null group by 1 order by 2 desc;
